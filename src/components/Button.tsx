  ...
  return (
    <button
      className={`${className} flex w-full max-w-[125px] items-center justify-center gap-4 rounded-lg
                  ...
                  hover:text-white hover:duration-300 focus:ring-offset-bg-color focus-visible:scale-110
                  focus-visible:bg-pink-400 focus-visible:text-white focus-visible:outline-none focus-visible:ring
                  focus-visible:ring-pink-400 focus-visible:ring-offset-2 active:scale-90 active:duration-150`}
      type="button"
      onClick={onClick}
    >
      {label || children}
